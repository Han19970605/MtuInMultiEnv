            ...
            do
                ...
                do
                    ...
                    do 
                        ...
                        do
                            .././waf --run "../scratch/mix.cc --DC_DELAY=$dc_delay --WAN_DELAY=$wan_delay --LOSS_RATE=$loss_rate --BANDWIDTH_LINK=$dc_bandwidth --ES_BANDWIDTH=$wan_bandwidth --SS_BANDWIDTH=$wan_bandwidth --LOAD=$load"
                        done
                    done
                done
            done
