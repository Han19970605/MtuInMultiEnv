...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-Wno-error', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CFLAGS_PYEMBED = ['-fdebug-prefix-map=/build/python3.7-GMPxCG/python3.7-3.7.5=.', '-fstack-protector', '-fwrapv']
CFLAGS_PYEXT = ['-fdebug-prefix-map=/build/python3.7-GMPxCG/python3.7-3.7.5=.', '-fstack-protector', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fdebug-prefix-map=/build/python3.7-GMPxCG/python3.7-3.7.5=.', '-fstack-protector', '-fwrapv']
CXXFLAGS_PYEXT = ['-fdebug-prefix-map=/build/python3.7-GMPxCG/python3.7-3.7.5=.', '-fstack-protector', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
ENABLE_GTK2 = '-pthread -I/usr/local/include -I/usr/include/gtk-2.0 -I/usr/lib/x86_64-linux-gnu/gtk-2.0/include -I/usr/include/gio-unix-2.0/ -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pixman-1 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libpng16 -I/usr/include/pango-1.0 -I/usr/include/harfbuzz -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/freetype2 -I/usr/include/libpng16 -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfontconfig -lfreetype\n'
...
EXAMPLE_DIRECTORIES = ['stats', 'socket', 'energy', 'traffic-control', 'udp-client-server', 'ipv6', 'wireless', 'matrix-topology', 'naming', 'tutorial', 'routing', 'error-model', 'tcp', 'udp', 'realtime']
...
INCLUDES_GTK2 = ['/usr/local/include', '/usr/include/gtk-2.0', '/usr/lib/x86_64-linux-gnu/gtk-2.0/include', '/usr/include/gio-unix-2.0/', '/usr/include/cairo', '/usr/include/pango-1.0', '/usr/include/atk-1.0', '/usr/include/pixman-1', '/usr/include/gdk-pixbuf-2.0', '/usr/include/libpng16', '/usr/include/harfbuzz', '/usr/include/glib-2.0', '/usr/lib/x86_64-linux-gnu/glib-2.0/include', '/usr/include/freetype2']
...
LIB_LIBXML2 = ['xml2']
LIB_PYEMBED = ['python3.7m', 'crypt', 'pthread', 'dl', 'util', 'm']
LIB_PYEXT = ['python3.7m', 'crypt', 'pthread', 'dl', 'util', 'm']
LIB_RT = ['rt']
LIB_SQLITE3 = ['sqlite3']
LIB_ST = '-l%s'
...
cfg_files = ['/home/hanfeixue/ns3/MultiEnv/build/ns3/config-store-config.h', '/home/hanfeixue/ns3/MultiEnv/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
